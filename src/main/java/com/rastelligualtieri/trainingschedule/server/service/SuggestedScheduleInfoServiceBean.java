...
@Service
public class SuggestedScheduleInfoServiceBean {

    private static Logger log = LoggerFactory.getLogger(SuggestedScheduleInfoServiceBean.class);
    ...
    public ResponseEntity<ApiResponse> getSuggestedScheduleInfo(HttpServletRequest request){
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Error json parsing suggested schedules info.");
        }
